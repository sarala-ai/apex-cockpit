                ...
                {evalRows.map((e, i) => (
                  ...
                  >
                    ...
                    <span className="flex shrink-0 items-center gap-3 text-muted-foreground">
                      ...
                      {e.runId && (
                        <Link
                          to={`/observe/runs/${encodeURIComponent(e.runId)}`}
            ...
            {runRows.length === 0 ? (
              ...
              <ul className="space-y-1.5">
                {runRows.map((r) => (
                  <li key={r.runId}>
                    <Link
                      to={`/observe/runs/${encodeURIComponent(r.runId)}`}
                      className="flex items-center justify-between gap-2 rounded-md px-1.5 py-0.5 text-xs hover:bg-accent/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                    >
