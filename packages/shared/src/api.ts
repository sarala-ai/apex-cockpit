...
export const API = {
  ...
  orgUserSecretDefinitions: `${API_PREFIX}/orgs/:orgId/user-secret-definitions`,
  myOrgUserSecrets: `${API_PREFIX}/orgs/:orgId/me/user-secrets`,
  myOrgUserSecret: `${API_PREFIX}/orgs/:orgId/me/user-secrets/:secretId`,
