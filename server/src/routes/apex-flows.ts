 ...
 *
 *   GET  /apex/flows              — flow definitions visible to the apex install
 *                                   (via `apex flows list`, the producer-owns seam).
 *   POST /apex/flows/start        — attach a flow to an issue at node 0 and kick
